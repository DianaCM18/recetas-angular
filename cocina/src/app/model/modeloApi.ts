...
export namespace Convert {
    export function toWelcome1(json: string): Welcome {
        return cast(JSON.parse(json), r("Welcome"));
    }

    export function welcomeToJson1(value: Welcome): string {
    ...
    const typeMap: any = {
        "Welcome": o([
            { json: "meals", js: "meals", typ: a(r("Meal")) },
        ], false),
        "Meal": o([
            { json: "idMeal", js: "idMeal", typ: "" },
